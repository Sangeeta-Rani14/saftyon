...
const AntiTheft = dynamic(() => import('@/components/dashboard/AntiTheft'), {
    loading: () => (
        <div className="w-full h-[600px] bg-gray-50 animate-pulse rounded-[40px] flex items-center justify-center">
            <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Establishing Secure Connection...</p>
            </div>
        </div>
    ),
    ssr: false
